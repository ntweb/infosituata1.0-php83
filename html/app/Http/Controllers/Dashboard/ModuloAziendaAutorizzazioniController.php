...
class ModuloAziendaAutorizzazioniController extends Controller
{

    public static $controllers = [
        'sedi' => [
            'key' => 'sedi',
            'label' => 'Amministrazione sedi',
            'description' => 'Creazione e modifica delle sedi',
            'permission' => 'can_create_sedi'
        ],
        'gruppi' => [
            'key' => 'gruppi',
            'label' => 'Amministrazione gruppi',
            'description' => 'Creazione e modifica dei gruppi di utenti',
            'permission' => 'can_create_gruppi'
        ],
    ];
