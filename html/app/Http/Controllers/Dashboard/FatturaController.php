...
class FatturaController extends Controller
{
    ...
    {
        $query = Fattura::orderBy('created_at', 'desc');
        ...
        if($request->has('q')) {
            ...
            return view('dashboard.fattura.tables.index', $data);
        }
        ...
        $data['list'] = $query->paginate(500);
        return view('dashboard.fattura.index', $data);
    }
    ...
    {
        $data = [];
        return view('dashboard.fattura.modals.fattura-edit', $data);
    }
