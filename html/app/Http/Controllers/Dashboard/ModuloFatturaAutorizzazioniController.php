...
class ModuloFatturaAutorizzazioniController extends Controller
{
    ...
    public static $controllers = [
        'fatture' => [
            ...
            'description' => 'Creazione e modifica delle fatture',
            'permission' => 'can_create_fatture'
        ],
        'iva' => [
            'key' => 'iva',
            'label' => 'Amministrazione IVA ed esenzioni',
            'description' => 'Creazione e modifica di voci IVA ed esenzioni',
            'permission' => 'can_create_iva'
        ],
    ];
