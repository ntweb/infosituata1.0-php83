...
class ModuloClienteAutorizzazioniController extends Controller
{

    public static $controllers = [
        'clienti' => [
            'key' => 'clienti',
            'label' => 'Amministrazione clienti',
            'description' => 'Creazione e modifica dei clienti',
            'permission' => 'can_create_clienti'
        ],
    ];
