...
<div class="{{ $class }}">
    <div class="position-relative form-group">
        ...
        <div class="input-group mb-3">
            ...
            <select class="select2-clienti-ajax form-control {{  $_error_class }}" name="{{ $name }}" id="{{ isset($id) ? $id : $name }}" @if($_read_only) disabled readonly @endif data-controller="{{ $controller ?? null }}" data-dropdownParent="{{ $dropdownParent ?? null }}" style="width: 100%">
                @if($_item)
