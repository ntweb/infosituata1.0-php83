...
<div class="{{ $class }}">
    ...
    <div class="position-relative form-group">
        ...
        <input placeholder="{{ $placeholder }}" type="datetime-local" class="form-control {{  $_error_class }}" name="{{ $name }}" id="{{ isset($id) ? $id : $name }}" value="{{ old($name, $value) }}" autocomplete="off" maxlength="{{ $maxLength }}" @if($_read_only) disabled readonly @endif @if($_autofocus) autofocus @endif>
