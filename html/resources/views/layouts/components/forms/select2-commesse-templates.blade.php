...
<div class="{{ $class }}">
    <div class="position-relative form-group">
        ...
        <select class="select2-commesse-template-ajax form-control {{  $_error_class }}" name="{{ $name }}" id="{{ isset($id) ? $id : $name }}" style="width: 100%" @if($_read_only) disabled readonly @endif>
            @if($_template)
