...
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-8">
            ...
            @include('dashboard.attrezzature.forms.create')
            @if(isset($el))
                ...
                @include('dashboard.attrezzature.forms.bigtext')
            @endif
        </div>
        <div class="col-md-12 col-lg-4">
            @if(isset($el))
                ...
                @component('layouts.components.helpers.delete', ['el' => $el, 'redirect' => route('attrezzature.index')])
                @endcomponent
            @endif
        </div>
    </div>
