...
<div class="card-border mb-3 card card-body border-danger">
    <h5 class="card-title">Cancella controllo</h5>
    ...
    <br>
    <br>
    <form action="{{ route('controllo.destroy', $el->id) }}" method="POST">
        @csrf
        @method('DELETE')

        <input type="hidden" name="_redirect" value="{{ route('controllo.index') }}">
