@php
    $action = isset($action) ? $action : route('controllo.store', ['_item_id' => $item->id, '_type' => 'json']);
    ...
    <div class="mb-3 card main-card">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                @component('layouts.components.forms.select', ['name' => 'tipo_1', 'value' => @$el->tipo_1, 'elements' => ['ordinario' => 'Ordinario', 'straordinario' => 'Straordinario'], 'class' => 'col-md-6'])
                @endcomponent

                @component('layouts.components.forms.select', ['name' => 'tipo_2', 'value' => @$el->tipo_2, 'elements' => ['interno' => 'Interno', 'esterno' => 'Esterno'], 'class' => 'col-md-6'])
                @endcomponent

                @component('layouts.components.forms.text', ['name' => 'esecutore', 'value' => @$el->esecutore ? $el->esecutore : null, 'class' => 'col-md-12', 'helper' => 'Nominativo di chi ha effettuato il controllo'])
...
@section('modal')
    @include('dashboard.controllo.components.modal-delete-attachment')
@endsection
