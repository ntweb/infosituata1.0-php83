...
@section ('header')
    @component('layouts.components.header', ['subtitle' => 'Lista dei broadcast', 'icon' => 'bx bxl-whatsapp', 'right_component' => 'dashboard.whatsapp.components.index-header'])
        Whatsapp
    @endcomponent
@endsection
                                ...
                                <table class="text-nowrap table-lg mb-0 table table-hover">
                                    ...
                                    @foreach($list as $el)
                                        ...
                                        <tr class="{{ !$_is_opened ? 'bold' : null }}">
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('whatsapp.edit', [$el->id]) }}" class="btn btn-primary btn-sm">Apri</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
