...
@section ('header')
    @component('layouts.components.header', ['subtitle' => 'Lista dei mezzi', 'icon' => 'pe-7s-menu', 'right_component' => 'dashboard.mezzi.components.index-header'])
        Mezzi
    @endcomponent
@endsection
...
@section('search')
    <div class="search-wrapper @if(request()->has('q')) active @endif">
        <div class="input-holder">
            <input type="text" class="search-input" placeholder="Cerca" data-route="{{ route('mezzi.index' ) }}?q=" value="{{ request()->get('q') }}">
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right dropdown-menu-rounded dropdown-menu">
                                                    ...
                                                    @can('can_create_mezzi')
                                                        ...
                                                        <a href="{{ route('mezzi.edit', [$el->id]) }}" tabindex="0" class="dropdown-item"><i class="fas fa-fw fa-edit mr-2"></i> Edit</a>
                                                    @endcan
                                                </div>
                                            </div>
                                        </td>
