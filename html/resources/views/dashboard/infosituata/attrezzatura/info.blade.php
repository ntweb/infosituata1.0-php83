...
@section('header')
    ...
    @component('layouts.components.header', ['subtitle' => 'Infosituata', 'icon' => 'pe-7s-home', 'back' => $back, 'right_component' => 'dashboard.infosituata.attrezzatura.components.info-header', 'el' => $el])
