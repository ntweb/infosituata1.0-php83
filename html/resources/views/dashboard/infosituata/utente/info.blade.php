...
@section('header')
    ...
    @component('layouts.components.header', ['subtitle' => 'Infosituata', 'icon' => 'pe-7s-home', 'back' => $back, 'right_component' => 'dashboard.infosituata.utente.components.info-header', 'el' => $el])
                                    ...
                                    <table class="mb-0 table table-hover">
                                        ...
                                        @foreach($scadenze as $scadenza)
                                            ...
                                            <tr class="filter mod-{{ $scadenza->infosituata_moduli_details_id }} {{ $_class }}">
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ route('scadenzario.edit', [$scadenza->id]) }}"
