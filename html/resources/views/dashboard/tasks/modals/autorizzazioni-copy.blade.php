<form action="{{ route('task-autorizzazioni.copy') }}" class="ns" method="POST" data-callback="closeAllModal();">
    @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="">
                    <div class="row">
                        ...
                        @component('layouts.components.forms.select2-tasks', ['name' => 'copy_task_id', 'class' => 'col-md-12', 'value' => null, 'dropdownParent' => '#modalAutorizzazioniCopy'])
