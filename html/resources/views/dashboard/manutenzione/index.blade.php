...
@section('header')
    ...
    @component('layouts.components.header', ['subtitle' => $el->extras1, 'icon' => 'pe-7s-home', 'back' => $back, 'el' => isset($el) ? $el : null, 'right_component' => 'dashboard.manutenzione.components.index-header'])
        Manutenzione
    @endcomponent
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            @if(count($el->manutenzioni))
                <div class="main-card mb-3 card">
                    <div class="card-header">
                        <i class="header-icon lnr-screen icon-gradient bg-warm-flame"> </i>Manutenzioni
                        <div class="btn-actions-pane-right">
                            <a href="{{ route('manutenzione.export', $el->id) }}" class="btn btn-light btn-sm">Export scheda manutenzioni</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive pb-10">
                            <table class="mb-0 table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">Ricambi</th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @foreach($el->manutenzioni as $l)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $_tot_magazzino + $_tot_acquistati }}</td>
                                        <td class="text-right">
                                            <a href="{{ route('manutenzione.edit', $l->id) }}" class="btn btn-primary btn-sm">
                                                edit
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><b>{{ $_tot_ricambi }}</b></td>
                                    <td></td>
                                </tr>
                                </tfoot>
                            </table>
